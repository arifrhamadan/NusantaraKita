...
// Fetcher infinite
export const getKecamatanByKabKotaIdInfinite = async (
  params: GetKecamatanByKabKotaIdInfiniteParams,
) => {
...
const useGetKecamatanByKabKotaIdInfiniteScroll = (
  params: GetKecamatanByKabKotaIdInfiniteParams,
  queryOptions?: { enabled?: boolean },
) => {
  return useInfiniteQuery({
    queryKey: [
      'kecamatan-by-kabkota-infinite',
      params.kodeKabKota,
      params.limit,
      params.pagination,
    ],
