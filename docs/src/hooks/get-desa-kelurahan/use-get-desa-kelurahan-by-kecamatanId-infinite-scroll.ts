...
// Fetcher infinite
export const getDesaByKecamatanIdInfinite = async (
  params: GetDesaByKecamatanIdInfiniteParams,
) => {
...
const useGetDesaByKecamatanIdInfiniteScroll = (
  params: GetDesaByKecamatanIdInfiniteParams,
  queryOptions?: { enabled?: boolean },
) => {
  return useInfiniteQuery({
    queryKey: [
      'desa-by-kecamatan-infinite',
